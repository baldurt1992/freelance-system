...
- Rutas UI: `docs/main/UI_ROUTES.md`

**Después de fase 9:** el trabajo nuevo de disciplina técnica y refactor se canaliza por [../backlog/README.md](../backlog/README.md).
